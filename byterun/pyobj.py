...
class Function(object):
    ...
    def __call__(self, *args, **kwargs):
        if PY2 and self.func_name in ["<setcomp>", "<dictcomp>", "<genexpr>"]:
            ...
            # Py2 doesn't know how to inspect set comprehensions, dict comprehensions, or generator
            # expressions properly.  They are always functions of one argument, so just do the right thing.
